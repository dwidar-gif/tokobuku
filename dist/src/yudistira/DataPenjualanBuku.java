 ...
 * @author Ryan
 */
public class DataPenjualanBuku extends javax.swing.JInternalFrame {
DefaultTableModel dtm;
String tanggal1;
    /**
     * Creates new form DataPenjualanBuku
     */
    public DataPenjualanBuku() {
        initComponents();
        tampil_tabel();
        combo();
    }
    ...
    public void tampil_tabel(){
        Object[] Baris={"No Faktur","Tanggal Penjualan Buku","Kode Pelanggan","Nama Pelanggan","Alamat Pelanggan","No Telp Pelanggan","Kode Buku","Jenis Buku","Judul Buku","Penulis Buku","Tahun Terbit Buku","Jumlah Buku","Jenis Pembayaran","Total Penjualan"};
        ...
        col13.setPreferredWidth(150);
         ...
         try{
           String sql="Select * from DataPenjualanBuku";
           java.sql.Statement stmt= con.createStatement();
           java.sql.ResultSet rslt=stmt.executeQuery(sql);
           while(rslt.next()){
               String a=rslt.getString("noFaktur");
               String b=rslt.getString("TglPenjualanBuku");
               ...
               String m=rslt.getString("JnsPembayaran");
    ...
    public void save () {
        ...
        try{
            String sql="insert into DataPenjualanBuku(noFaktur,TglPenjualanBuku,KdPelanggan,NmPelanggan,AlmtPelanggan,NoTelpPelanggan,KdBuku,JnsBuku,JdlBuku,PnlsBuku,ThnTrbtBuku,JmlBuku,JnsPembayaran,TtlPembayaran)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            try{
                ...
                stmt.setString(13,jComboBox3.getSelectedItem().toString());
    ...
    public void update(){
         java.sql.Connection conn = new konek().connect();
            ...
            String n=jTextField11.getText();
                ...
                try{
                            String query="UPDATE datapenjualanbuku SET TglPenjualanBuku='"+b+"',KdPelanggan='"+c+"',NmPelanggan='"+d+"',AlmtPelanggan='"+e+"',NoTelpPelanggan='"+f+"',KdBuku='"+g+"',JnsBuku='"+h+"',JdlBuku='"+i+"',PnlsBuku='"+j+"',ThnTrbtBuku='"+k+"',JmlBuku='"+l+"',JnsPembayaran='"+m+"',TtlPembayaran='"+n+"'where noFaktur='"+a+"'";
    ...
    public void delete(){
        ...
        if(ok==0){
            try{
                String sql="delete from datapenjualanbuku where noFaktur='"+jTextField1.getText()+"'";
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Data Penjualan Buku");
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Item", "Tunai", "Kredit" }));
    ...
    private void jTextField3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField3ActionPerformed
        // TODO add your handling code here:
             java.sql.Connection con = new konek().connect();
         try{
           String sql="Select * from datapelanggan where kdpelanggan ='"+jTextField3.getText()+"'";
           java.sql.Statement stmt= con.createStatement();
           java.sql.ResultSet rslt=stmt.executeQuery(sql);
           while(rslt.next()){
               String a=rslt.getString("nmpelanggan");
               jTextField4.setText(a);
               String b=rslt.getString("AlmtPelanggan");
               jTextArea1.setText(b);
               String c=rslt.getString("NoTelpPelanggan");
    ...
    private void jTextField7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField7ActionPerformed
        // TODO add your handling code here:
         ...
         try{
           String sql="Select * from databuku where KdBuku ='"+jTextField7.getText()+"'";
           java.sql.Statement stmt= con.createStatement();
           java.sql.ResultSet rslt=stmt.executeQuery(sql);
           while(rslt.next()){
               String a=rslt.getString("JnsBuku");
               jComboBox1.setSelectedItem(a);
               String b=rslt.getString("JdlBuku");
               jTextField8.setText(b);
               String c=rslt.getString("PnlsBuku");
               jTextField9.setText(c);
               String d=rslt.getString("ThnTrbtBuku");
                int xx = Integer.parseInt(d);
               jComboBox2.setSelectedItem(xx);
               String e=rslt.getString("JmlBuku");
