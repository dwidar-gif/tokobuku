 ...
 * @author Ryan
 */
public class DataPenagihan extends javax.swing.JInternalFrame {
DefaultTableModel dtm;
String tanggal1;
    /**
     * Creates new form DataPemesananBuku
     */
    public DataPenagihan() {
        initComponents();
        tampil_tabel();
    }
    
    public void tampil_tabel(){
        Object[] Baris={"No Faktur","Tanggal Jatuh Tempo","Kode Pelanggan","Nama Pelanggan","Alamat Pelanggan","No Telp Pelanggan","Kode Buku","Jenis Buku","Judul Buku","Jumlah Buku","Total Pembayaran"};
        ...
        col10.setPreferredWidth(150);
         ...
         try{
           String sql="Select * from DataPenagihan";
           java.sql.Statement stmt= con.createStatement();
           java.sql.ResultSet rslt=stmt.executeQuery(sql);
           while(rslt.next()){
               String a=rslt.getString("NoFaktur");
               String b=rslt.getString("TglJthTempo");
               ...
               String k=rslt.getString("TtlPembayaran");

               String[] dataField={a,b,c,d,e,f,g,h,i,j,k};
    ...
    public void save () {
        ...
        try{
            String sql="insert into DataPenagihan(NoFaktur,TglJthTempo,KdPelanggan,NmPelanggan,AlmtPelanggan,NoTelpPelanggan,KdBuku,JnsBuku,JdlBuku,JmlBuku,TtlPembayaran)values(?,?,?,?,?,?,?,?,?,?,?)";
            ...
            try{
                ...
                stmt.setString(11,jTextField10.getText());
    ...
    public void update(){
         java.sql.Connection conn = new konek().connect();
            ...
            String k=jTextField10.getText();
                ...
                try{
                            String query="UPDATE DataPenagihan SET TglJthTempo='"+b+"',KdPelanggan='"+c+"',NmPelanggan='"+d+"',AlmtPelanggan='"+e+"',NoTelpPelanggan='"+f+"',KdBuku='"+g+"',JnsBuku='"+h+"',JdlBuku='"+i+"',JmlBuku='"+j+"',TtlPembayaran='"+k+"'where NoFaktur='"+a+"'";
    ...
    public void delete(){
        ...
        if(ok==0){
            try{
                String sql="delete from DataPenagihan where NoFaktur='"+jTextField1.getText()+"'";
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Data Penagihan");
